...
footerTemplate.innerHTML = `
    ...
    <section class="contacto">
        ...
        <img class="contacto__div__link__logo logo" alt="Logo de AluraGeek">
            <nav class="listaNavegacion__navegacion">
                <ul>
                    <li class="listaNavegacion__enlace"><a href="#">Puedes dejarnos Tus inquietudes</a></li>  
                </ul>
            </nav>
        </div>
    ...
    <footer class="footer">
            <a class="footer__link" href="#">Desarrollado por Rodolfo Parada</a>
            <ul class="footer__social-row">
                <li><a class="footer__link" href="https://github.com/RodolfoParada" target="_blank"><i class="fab fa-github"></i></a></li>
                <li><a class="footer__link" href="https://www.linkedin.com/in/rodolfoparada/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
            </ul>
    </footer>
`;
